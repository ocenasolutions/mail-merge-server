  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        description: homepageData.description || homepageData.aboutSnippet || secondaryPageData.aboutSnippet || '',
        aboutSnippet: homepageData.aboutSnippet || secondaryPageData.aboutSnippet || homepageData.description || `Platform operating at ${domain}`,
